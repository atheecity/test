# France Taxi OpenAPI Specification
[![Build Status](https://travis-ci.com/atheecity/test.svg?branch=master)](https://travis-ci.com/atheecity/test)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://atheecity.github.io/test/)
- OpenAPI Raw Files: [JSON](https://atheecity.github.io/test/openapi.json) [YAML](https://atheecity.github.io/test/openapi.yaml)
